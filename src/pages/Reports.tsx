...
function Reports() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-8">
      ...
      <p className="text-sm text-gray-400 mb-6">Download the full Go &amp; Return profit report for any truck, for any year.</p>
      ...
      {loading ? (
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-x-auto">
          ...
          {trucks.length === 0 && (
            <div className="text-center py-12 text-gray-400 text-sm">No trucks registered yet.</div>
          )}
        </div>
      )}
    </div>
